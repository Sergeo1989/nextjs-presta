...
/**
 * @description Get products by ids or categories
 * @param {string} type - Type of the list, either 'history' or 'related'
 * @param {string} ids - Comma-separated list of product ids
 * @param {string} categories - Comma-separated list of product categories
 * @returns {NextResponse} Json response containing products data
 */
